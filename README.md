...
<details>
  ...
  - [The `<audio>` tag](#the-audio-tag)
    - [Basic Usage](#the-basic-usage-is-as-following)
    - [Breakdown](#lets-break-down-the-code-snippets-above)

- [The `<video>` tag](#the-video-tag)

- [The `<iframe>` tag](#the-iframe-tag)

  - [Attributes on `<iframe>`](#attributes-on-iframe)
  - [Properties on the iframe obejct](#properties-on-an-iframe-reference)
  - [Functionality](#functionality)
  - [Common use cases](#common-use-cases)
  - [Security Challenges](#security-challenges)

- [The HTMLMediaElement Interface](#the-htmlmediaelement-interface)
  - [Methods](#methods)
...
The `<audio>` tag is used to add sound content to your application, such as music or other different types of sounds. Here is the documentation from w3schools: [w3Schools `<audio>` tag](https://www.w3schools.com/tags/tag_audio.asp)
...
There are also more attributes available on an iframe, this is just a few of them. More info can be found here: [HTML `<iframe>` teag](https://www.w3schools.com/tags/tag_iframe.asp)
...
More info here: [HTML DOM iframe object](https://www.w3schools.com/jsref/dom_obj_frame.asp)
...
Read more about it here: [7 Required Steps to Secure Your iFrames Security](https://www.reflectiz.com/blog/iframe-security/)
...
- [w3Schools Audio/Video DOM Reference](https://www.w3schools.com/tags/ref_av_dom.asp)

- [HTMLMediaElement Interface](https://developer.mozilla.org/en-US/docs/Web/API/HTMLMediaElement)
